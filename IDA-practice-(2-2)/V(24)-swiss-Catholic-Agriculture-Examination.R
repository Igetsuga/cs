  ...
  #   описывает модель, т.е. регрессор x1- Agriculture очень плохо описывает 
  #   динамику переменной y- Catholic, значит нужно выбрать другого регрессора.
  
  # 2)Оценим связь между регрессором x1 и переменной y.
  #   (Intercept)   3.8313    13.8966   0.276   0.7840
  #   Agriculture   0.7365     0.2508   2.937   0.0052 **
  #   По полученным данным можно сказать, что какая-то связь между реггрессором и
  ...
  #   переменной кроме того, нет никакой связи между свободнфм коэфф. 
  #   и переменной y.
